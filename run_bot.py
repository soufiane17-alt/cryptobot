...
print("🚀 CryptoBot Simulator - AUTO-ENTRAÎNEMENT activé")
print("Le bot trade automatiquement avec l'argent virtuel (seuil 65)\n")
...
while True:
    ...
    for symbol in ["BTC/USDT", "ETH/USDT", "SOL/USDT"]:
        ...
        # Auto-trade si score suffisant
        if signal["score"] >= 65 and signal["signal"] in ["BUY", "SELL"]:
            amount = 200
